...
public abstract class EndlessRecyclerViewScrollListener extends RecyclerView.OnScrollListener {
    ...
    private EndlessRecyclerViewScrollListener(RecyclerView.LayoutManager layoutManager, int startingPageIndex) {
    ...
    public EndlessRecyclerViewScrollListener(LinearLayoutManager layoutManager, int startingPageIndex) {
        this(((RecyclerView.LayoutManager) layoutManager), startingPageIndex);
    }
